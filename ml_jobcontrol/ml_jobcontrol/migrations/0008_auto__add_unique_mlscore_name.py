...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MLScore', fields ['name']
        db.create_unique(u'ml_jobcontrol_mlscore', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'MLScore', fields ['name']
        db.delete_unique(u'ml_jobcontrol_mlscore', ['name'])
