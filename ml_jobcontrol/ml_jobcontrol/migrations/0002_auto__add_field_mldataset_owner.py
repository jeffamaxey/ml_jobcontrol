...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MLDataSet.owner'
        db.add_column(u'ml_jobcontrol_mldataset', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mldatasets', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MLDataSet.owner'
        db.delete_column(u'ml_jobcontrol_mldataset', 'owner_id')
