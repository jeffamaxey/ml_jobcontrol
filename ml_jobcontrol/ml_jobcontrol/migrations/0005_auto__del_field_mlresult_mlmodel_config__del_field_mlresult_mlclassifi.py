...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MLResult.mlmodel_config'
        db.delete_column(u'ml_jobcontrol_mlresult', 'mlmodel_config_id')

        # Deleting field 'MLResult.mlclassification_testset'
        db.delete_column(u'ml_jobcontrol_mlresult', 'mlclassification_testset_id')

        # Adding field 'MLResult.mljob'
        db.add_column(u'ml_jobcontrol_mlresult', 'mljob',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ml_jobcontrol.MLJob']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MLResult.mlmodel_config'
        db.add_column(u'ml_jobcontrol_mlresult', 'mlmodel_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 7, 13, 0, 0), to=orm['ml_jobcontrol.MLModelConfig']),
                      keep_default=False)

        # Adding field 'MLResult.mlclassification_testset'
        db.add_column(u'ml_jobcontrol_mlresult', 'mlclassification_testset',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ml_jobcontrol.MLClassificationTestSet']),
                      keep_default=False)

        # Deleting field 'MLResult.mljob'
        db.delete_column(u'ml_jobcontrol_mlresult', 'mljob_id')
