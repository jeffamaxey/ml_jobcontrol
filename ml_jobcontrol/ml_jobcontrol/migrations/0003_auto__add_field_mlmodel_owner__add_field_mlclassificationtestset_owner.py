...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MLModel.owner'
        db.add_column(u'ml_jobcontrol_mlmodel', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mlmodels', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'MLClassificationTestSet.owner'
        db.add_column(u'ml_jobcontrol_mlclassificationtestset', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mlclassificationtestsets', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MLModel.owner'
        db.delete_column(u'ml_jobcontrol_mlmodel', 'owner_id')

        # Deleting field 'MLClassificationTestSet.owner'
        db.delete_column(u'ml_jobcontrol_mlclassificationtestset', 'owner_id')
    ...
    models = {
        ...
        u'ml_jobcontrol.mlmodelconfig': {
            ...
            'mlmodel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mlmodel'", 'to': u"orm['ml_jobcontrol.MLModel']"})
        },
