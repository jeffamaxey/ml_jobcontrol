...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MLResultScore.mlresult'
        db.delete_column(u'ml_jobcontrol_mlresultscore', 'mlresult_id')

        # Adding field 'MLResultScore.mljob'
        db.add_column(u'ml_jobcontrol_mlresultscore', 'mljob',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['ml_jobcontrol.MLJob']),
                      keep_default=False)
        ...
        # Adding field 'MLJob.status'
        db.add_column(u'ml_jobcontrol_mljob', 'status',
                      self.gf('model_utils.fields.StatusField')(default='todo', max_length=100, no_check_for_status=True),
                      keep_default=False)

        # Adding field 'MLJob.status_changed'
        db.add_column(u'ml_jobcontrol_mljob', 'status_changed',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ml_jobcontrol_mlresult', (
            ('mljob', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ml_jobcontrol.MLJob'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'ml_jobcontrol', ['MLResult'])

        # Adding field 'MLResultScore.mlresult'
        db.add_column(u'ml_jobcontrol_mlresultscore', 'mlresult',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ml_jobcontrol.MLResult']),
                      keep_default=False)

        # Deleting field 'MLResultScore.mljob'
        db.delete_column(u'ml_jobcontrol_mlresultscore', 'mljob_id')
        ...
        # Deleting field 'MLJob.status'
        db.delete_column(u'ml_jobcontrol_mljob', 'status')

        # Deleting field 'MLJob.status_changed'
        db.delete_column(u'ml_jobcontrol_mljob', 'status_changed')
